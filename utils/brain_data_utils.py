...
def get_loader(args):
    ...
    datalist = BrainImgDataset(root_dir, modality_path,table_dir, split='train').dict_paths
    val_files = BrainImgDataset(root_dir, modality_path,table_dir, split='val').dict_paths
